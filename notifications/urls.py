...
urlpatterns = [
    ...
    path("api/notifications/read-all/", views.api_read_all_notifications, name="api_read_all_notifications"),
    ...
    path("api/mails/read-all/", views.api_read_all_mails, name="api_read_all_mails"),
